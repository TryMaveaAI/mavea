...
describe('readTheme', () => {
  ...
  it('falls back to light for an invalid stored value (the drift this module fixes)', () => {
  ...
  it('opts into dark only on an exact stored "dark"', () => {
    localStorage.setItem(THEME_KEY, 'dark');
    expect(readTheme()).toBe('dark');
  });

  it('defaults to light when reading storage throws', () => {
