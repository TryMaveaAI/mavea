          ...
          <>
            ...
            <AdvancedGroup>
              ...
              <ToggleRow
                ...
                note="When you ask why something happened, Mavéa offers the causal web behind the answer — every arrow shows its source, and follow-ups reshape the same web instead of starting over. Offering one makes no model call: the web is generated only when you open it, once, and then it's kept."
              />
              <ToggleRow
