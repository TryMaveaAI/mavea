...
export function LiveApp(): ReactElement {
  ...
  const mindOverlay = mindActive ? (
    // The bottom reserve comes off --dock-h (mindshape.css), the dock's one measurement of itself.
    // The dock paints an opaque surface across its whole height, so a reserve short of it doesn't
    // crop the map — it hides whatever the map drew there, action bar included.
