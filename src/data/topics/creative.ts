...
export const creative: ConversationSpec = {
  ...
  blocks: [
        ...
        tiles: [
          {
            ...
            src: '/demo-assets/images/sete-cidades.avif',
          },
          {
            kind: 'text',
            span: 2,
          ...
          { kind: 'color', swatch: 'var(--presence)', hex: '#2f9e7a', label: 'Caldera green' },
          {
            ...
            src: '/demo-assets/images/green-coast.avif',
          },
          { kind: 'color', swatch: 'var(--insight)', hex: '#6ea8ff', label: 'Atlantic grey-blue' },
          {
            ...
            label: 'Gorreana · tea terraces in the green interior',
            src: '/demo-assets/images/tea-terraces.avif',
          },
          {
            kind: 'image',
            from: 'var(--presence-deep)',
            ...
            src: '/demo-assets/images/furnas-lake.avif',
          },
    ...
    // ── 2b. photo (media), a real reference frame ──
    {
      ...
      props: {
        title: 'Mood frame',
        src: '/demo-assets/images/arnel-lighthouse.avif',
        alt: 'The red lantern of Farol do Arnel above the sea, Nordeste',
      ...
      props: {
        ...
        slides: [
          ...
          },
          {
            ...
            to: 'var(--insight)',
            tag: 'close',
            src: '/demo-assets/images/sea-cliffs.avif',
          },
        ],
    ...
    // ── 7. lightbox (media), the shot grid ──
    {
      ...
      props: {
        ...
        items: [
          {
            label: 'Nordeste · arrival',
            caption: 'Day 1 · 35mm · grey',
            from: 'var(--text-muted)',
            to: 'var(--presence-deep)',
            src: '/demo-assets/images/nordeste-town.avif',
          },
          {
          ...
          },
          {
            ...
            from: 'var(--presence)',
            to: 'var(--insight)',
            src: '/demo-assets/images/cliff-fields.avif',
          },
          {
            ...
            to: 'var(--presence-deep)',
            src: '/demo-assets/images/crater-panorama.avif',
          },
        ],
    ...
    // ── 8. beforeafter (media), the grade ──
    {
      ...
      props: {
        ...
        before: {
          ...
          src: '/demo-assets/images/green-coast-raw.avif',
        },
        after: {
          label: 'Graded',
          from: 'var(--presence)',
        ...
        callouts: [
          {
            ...
            y: 26,
            label: 'Horizon high',
            detail: 'Sky to the top third, the caldera rim is the subject.',
            color: 'var(--presence)',
          },
          {
            x: 37,
            y: 52,
            label: 'Blue lake',
            detail: 'The deeper water holds the middle band.',
            color: 'var(--insight)',
          },
          {
            x: 64,
            y: 70,
            label: 'Green lake',
            detail: 'The warmer green balances it, low and right.',
            color: 'var(--warning)',
          },
          {
            x: 50,
            y: 92,
            label: 'Foreground trees',
            detail: 'A screen of cryptomeria grounds the frame.',
            color: 'var(--text-muted)',
          },
        ],
    ...
    // ── 11. videoembed (media), the cut ──
    {
      ...
      id: 'film',
      props: {
        title: 'The cut, so far',
        icon: 'play',
        iconColor: 'var(--presence)',
        thumb: {
          from: 'var(--presence-deep)',
          to: 'var(--insight)',
          label: 'Rough plate · sea and rock',
        },
        video: '/demo-assets/video/island-coast.webm',
        poster: '/demo-assets/images/island-coast-poster.avif',
        durationLabel: '0:20',
        active: 1,
        // Marks are a percentage of the clip's real duration, so they have to move with it.
        chapters: [
          { time: '0:00', at: 0, title: 'Cold open · the shelf' },
          { time: '0:06', at: 30, title: 'The set builds' },
          { time: '0:09', at: 45, title: 'The break' },
          { time: '0:15', at: 74, title: 'Still water · out' },
        ],
        footer: 'A twenty-second plate for the cold open, cut to length.',
      },
    },
    ...
    // ── creativetest (media) — the two launch posts, A/B tested ──
    {
      ...
      props: {
        ...
        variants: [
          ...
          {
            label: 'Variant B · the crater lake',
            src: '/demo-assets/images/crater-panorama.avif',
  ...
  intents: {
    ...
    film: {
      kind: 'spotlight',
      spotId: 'film',
      say: "Here's the cut so far, chaptered to the plate.",
    },
