...
**Node >= 20** (run `corepack enable` once to activate the pinned pnpm). That's enough for the app
...
| OpenAI     | `gpt-5.4-mini`            | Fast, low-cost default; `gpt-5.6-luna` steps up, `gpt-5.4-nano` is cheapest       |
